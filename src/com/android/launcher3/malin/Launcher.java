...
import com.android.launcher3.malin.DropTarget.DragObject;
import com.android.launcher3.malin.LauncherSettings.Favorites;
import com.android.launcher3.malin.Workspace.ItemOperator;
import com.android.launcher3.malin.accessibility.LauncherAccessibilityDelegate;
import com.android.launcher3.malin.allapps.AllAppsContainerView;
import com.android.launcher3.malin.allapps.AllAppsTransitionController;
import com.android.launcher3.malin.anim.AnimationLayerSet;
import com.android.launcher3.malin.compat.AppWidgetManagerCompat;
import com.android.launcher3.malin.compat.LauncherAppsCompat;
import com.android.launcher3.malin.compat.LauncherAppsCompatVO;
import com.android.launcher3.malin.compat.UserManagerCompat;
import com.android.launcher3.malin.config.FeatureFlags;
import com.android.launcher3.malin.dragndrop.DragController;
import com.android.launcher3.malin.dragndrop.DragLayer;
import com.android.launcher3.malin.dragndrop.DragOptions;
import com.android.launcher3.malin.dragndrop.DragView;
import com.android.launcher3.malin.dragndrop.PinItemDragListener;
import com.android.launcher3.malin.dynamicui.ExtractedColors;
import com.android.launcher3.malin.dynamicui.WallpaperColorInfo;
import com.android.launcher3.malin.folder.Folder;
import com.android.launcher3.malin.folder.FolderIcon;
import com.android.launcher3.malin.keyboard.CustomActionsPopup;
import com.android.launcher3.malin.keyboard.ViewGroupFocusHelper;
import com.android.launcher3.malin.logging.FileLog;
import com.android.launcher3.malin.logging.UserEventDispatcher;
import com.android.launcher3.malin.model.ModelWriter;
import com.android.launcher3.malin.model.PackageItemInfo;
import com.android.launcher3.malin.model.WidgetItem;
import com.android.launcher3.malin.notification.NotificationListener;
import com.android.launcher3.malin.pageindicators.PageIndicator;
import com.android.launcher3.malin.popup.PopupContainerWithArrow;
import com.android.launcher3.malin.popup.PopupDataProvider;
import com.android.launcher3.malin.shortcuts.DeepShortcutManager;
import com.android.launcher3.malin.userevent.nano.LauncherLogProto;
import com.android.launcher3.malin.userevent.nano.LauncherLogProto.Action;
import com.android.launcher3.malin.userevent.nano.LauncherLogProto.ContainerType;
import com.android.launcher3.malin.userevent.nano.LauncherLogProto.ControlType;
import com.android.launcher3.malin.util.ActivityResultInfo;
import com.android.launcher3.malin.util.RunnableWithId;
import com.android.launcher3.malin.util.ComponentKey;
import com.android.launcher3.malin.util.ComponentKeyMapper;
import com.android.launcher3.malin.util.ItemInfoMatcher;
import com.android.launcher3.malin.util.MultiHashMap;
import com.android.launcher3.malin.util.PackageManagerHelper;
import com.android.launcher3.malin.util.PackageUserKey;
import com.android.launcher3.malin.util.PendingRequestArgs;
import com.android.launcher3.malin.util.SystemUiController;
import com.android.launcher3.malin.util.TestingUtils;
import com.android.launcher3.malin.util.Themes;
import com.android.launcher3.malin.util.Thunk;
import com.android.launcher3.malin.util.ViewOnDrawExecutor;
import com.android.launcher3.malin.widget.PendingAddShortcutInfo;
import com.android.launcher3.malin.widget.PendingAddWidgetInfo;
import com.android.launcher3.malin.widget.WidgetAddFlowHandler;
import com.android.launcher3.malin.widget.WidgetHostViewLoader;
import com.android.launcher3.malin.widget.WidgetsContainerView;
...
import static com.android.launcher3.malin.util.RunnableWithId.RUNNABLE_ID_BIND_APPS;
import static com.android.launcher3.malin.util.RunnableWithId.RUNNABLE_ID_BIND_WIDGETS;
...
public class Launcher extends BaseActivity
    ...
    /**
     * $ adb shell dumpsys activity com.android.launcher3.malin.Launcher [--all]
     */
    @Override
